...
htmlhelp_basename = "isleservice_objectsdoc"
...
latex_documents = [
    (
        master_doc,
        "isleservice_objects.tex",
        "isleservice_objects Documentation",
        "Billy PeAKE",
        "manual",
    )
]
...
man_pages = [
    (master_doc, "isleservice_objects", "isleservice_objects Documentation", 1)
]
